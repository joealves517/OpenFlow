  ...
  return (
    <footer className="border-t border-white/10 bg-[#050505] pt-16 pb-8" role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-12 mb-16">
        <div className="w-full md:w-1/3">
          <div className="flex items-center gap-2 mb-4">
            <Link href="/" className="flex items-center gap-2 group" aria-label="VidFlow - Go to home">
              <Image src="/images/logo-vidflow.png" alt="" width={50} height={50} aria-hidden="true" />
              <Image src="/images/text-vidflow.png" alt="VidFlow" width={100} height={50} />
            </Link>
          </div>
        ...
        <div className="flex gap-12 md:gap-24">
          ...
          <nav aria-label={t('contact')}>
            ...
            <ul className="space-y-3 text-sm text-neutral-500">
              <li><a href="https://github.com/CristianOlivera1/VidFlow" target="_blank" className="hover:text-white transition-colors">{t('github')}</a></li>
            </ul>
          </nav>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
        <span className="text-xs text-neutral-600">© {currentYear} VidFlow {t('rights')}</span>
