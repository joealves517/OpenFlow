        ...
        <Dialog.Content className="fixed top-0 right-0 bottom-0 w-70 bg-[#0a0a0a] border-l border-white/10 z-50 animate-in slide-in-from-right duration-300 flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-white/5">
            <div className="flex flex-col">
              ...
              <Link href="/" onClick={closeMenu} className="flex items-center gap-2">
                <Image src="/images/logo-vidflow.png" alt="Logo" width={32} height={32} />
                <Image src="/images/text-vidflow.png" alt="VidFlow" width={80} height={20} />
              </Link>
            </div>
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <div className="space-y-2">
              ...
              <a
                href="https://github.com/CristianOlivera1/VidFlow"
                target="_blank"
